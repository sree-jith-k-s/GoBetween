    ...
    <body>
        ...
        <%
            ...
            if (isMultipart) {
                ...
                {
                String InsQry = "insert into tbl_user(user_name,user_contact,user_dob,user_email,user_address,location_id,user_photo,user_password,user_aadhar_number,user_doj)"
                        + "values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + value[3] + "','" + value[4] + "','" + value[7] + "','" + photo + "','" + value[9] + "','" + value[8] + "',curdate())";
