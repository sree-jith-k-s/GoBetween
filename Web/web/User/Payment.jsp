<%-- 
    Document   : Payment
    Created on : Jan 1, 2009, 1:22:56 AM
    Author     : PSST
--%>
    ...
    <head>
        ...
        <div class="wrapper">
            ...
            <form method="POST">
                ...
                <div class="input-group">
                    <div class="input-box">
                        <input class="name" type="text" id="txtcardno" name="txtcardno" value="INR  <%=count%>(25% of total amount)" required="required" readonly="">
                ...
                <%
                    ...
                    if (request.getParameter("btnpay") != null) {
                        ...
                        String upQry = "update tbl_transport_shedule set transport_shedule_status='2' where transport_shedule_id='" + request.getParameter("hid") + "'";
