<%-- 
    Document   : NewUser
    Created on : May 28, 2021, 5:36:43 PM
    Author     : Pro-TECH
--%>
...
<html lang="en">
    ...
    <%
        if (request.getParameter("btn_submit") != null) {
            ...
            String anumber = request.getParameter("txt_anumber");
            String email = request.getParameter("txt_email");
            String location = request.getParameter("sel_location");

            String insQry = "insert into tbl_user (user_name,user_contact,user_dob,user_doj,user_address,user_password,user_aadhar_number,user_email,location_id)"
                    + "values('" + name + "','" + contact + "','" + dob + "',curdate(),'" + address + "','" + password + "','" + anumber + "','" + email + "','" + location + "')";
                ...
                <div class="outer-panel">
                    <div class="outer-panel-inner">
                        <div class="process-title">
                            ...
                            <h2 id="step-title-2" class="step-title is-active" style="margin-top: 20px">Tell us more about you.</h2>
                            <h2 id="step-title-4" class="step-title" style="margin-top: 20px">Security.</h2>
                            ...
                            <div class="columns mt-4">
                                <div class="column is-4">
                                    <div class="account-type">
                                        ...
                                        <a class="button is-fullwidth process-button" href="NewCompany.jsp" data-step="step-dot-2">
                                            Continue
                                        </a>
                                    </div>
                                </div>
                                <div class="column is-4">
                                    <div class="account-type">
                                        ...
                                        <a class="button is-fullwidth process-button" href="NewDriver.jsp" data-step="step-dot-2">
                                            Continue
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div id="signup-panel-2" class="process-panel-wrap is-narrow is-active">
                            <div class="form-panel">
                                <div class="field">
                                    <label>Name</label>
                                    <div class="control">
                                        <input type="text" required="" name="txt_name" class="input" placeholder="Enter your name">
                                    </div>
                                </div>
                                <div class="field">
                                    <label>Contact</label>
                                    <div class="control">
                                        <input type="text" required="" class="input" name="txt_contact" placeholder="Enter contact number">
                                    </div>
                                </div>
                                <div class="field">
                                    <label>Address</label>
                                    <div class="control">
                                        <input type="text" required="" class="input" name="txt_address" placeholder="Enter your address">
                                    </div>
                                </div>
                                <div class="field">
                                    <label>DOB</label>
                                    <div class="control">
                                        <input type="date" required="" name="date_dob" class="input" >
                                    </div>
                                </div>
                                <div class="field">
                                    <label>State</label>
                        ...
                        <div id="signup-panel-4" class="process-panel-wrap is-narrow">
                            <div class="form-panel">
                                <div class="field">
                                    ...
                                    <div class="control">
                                        <input type="text" required="" class="input" name="txt_anumber"  placeholder="Enter your Aadhar number">
                                    </div>
                                </div>
                                <div class="field">
                                    <label>Email</label>
                                    <div class="control">
                                        <input type="text" required="" class="input" name="txt_email"  placeholder="Enter your email address">
                                    </div>
                                </div>
                                <div class="field">
                                    ...
                                    <div class="control">
                                        <input type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
                                               title="Must contain at least one  number and one uppercase and lowercase letter, and at least 8 or more characters" required="" name="txt_password" class="input" placeholder="1 no,1 cap,1 small and char >= 8">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="signup-panel-5" class="process-panel-wrap is-narrow">
                            <div class="form-panel">
                                ...
                                <div class="success-text">
                                    ...
                                    <input type="submit" name="btn_submit" class="button is-fullwidth" value="Let me in">
                                </div>
                            </div>
                        </div>
                    </div>
