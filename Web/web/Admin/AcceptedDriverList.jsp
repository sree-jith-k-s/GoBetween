<%-- 
    Document   : AcceptedDriverList
    Created on : May 16, 2021, 3:15:56 PM
    Author     : Pro-TECH
--%>
...
<html lang="en" >
    <head>
        ...
        if(request.getParameter("rdid")!=null)
        {
            ...
            response.sendRedirect("AcceptedDriverList.jsp");
        }
    ...
    <body>
        <h1 align="center" id="heading">Accepted Driver List</h1>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                   int i = 0;
                    String selQry = "select * from tbl_driver c inner join tbl_location l on l.location_id=c.location_id inner join tbl_district d on d.district_id=l.district_id inner join tbl_state s on s.state_id=d.state_id where driver_status='1'";
                ...
                <tr>
                    ...
                    <td><a href="AcceptedDriverList.jsp?rdid=<%=rs.getString("driver_id")%>">Reject</a></td>
                </tr>
                <%
                    }
