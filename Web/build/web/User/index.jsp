    ...
    <body data-spy="scroll" data-offset="0" data-target="#navbar-main">
            ...
            <div class="navbar navbar-default navbar-fixed-top">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a href="index.jsp"><h3> Go-Between</h3></a>
                    </div>
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <div class="dropdown">
                                <a class="dropbtn" href="SearchCompany.jsp">Company</a>
                            </div>
                            <div class="dropdown">
        ...
        <div id="headerwrap" >
            <header class="clearfix">
                <h1 class="animated bounceIn">Welcome <br><%=session.getAttribute("uname")%></h1>
