<%-- 
    Document   : NewDriver
    Created on : May 28, 2021, 5:36:31 PM
    Author     : Pro-TECH
--%>
...
<%
        ...
        int yearnew = Integer.parseInt(year) - 20;
    ...
    <body>
        ...
        <div class="signup-wrapper">
            ...
            <form method="post" enctype="multipart/form-data" action="../Assets/ActionPages/DriverUploadAction.jsp">
                        ...
                        <div id="signup-panel-2" class="process-panel-wrap is-narrow is-active">
                            <div class="form-panel">
                                ...
                                <div class="field">
                                    ...
                                    <div class="control">
                                        <input type="text" required="" class="input" name="txt_pcontact" placeholder="Enter primary contact">
                                    </div>
                                </div>
                                 <div class="field">
                                    <label>Secondary Contact</label>
                                    <div class="control">
                                        <input type="text" required="" class="input" name="txt_scontact" placeholder="Enter secondary contact">
                                    </div>
                                </div>
                                <div class="field">
                                    <label>Address</label>
                                 ...
                                 <div class="field">
                                    ...
                                    <div class="control">
                                        <input type="text" required="" class="input" name="txt_exp" placeholder="Enter your experience">
                                    </div>
                                </div>
                                <div class="field">
                                    <label>DOB</label>
                                    <div class="control">
                                        <input type="date" required="" max="<%=Date%>" name="txtddate" class="input" >
                                    </div>
                                </div>
                                <div class="field">
                                    <label>State</label>
