    ...
    <%        
      if (request.getParameter("cid")!=null)
      {
          String cid=request.getParameter("cid"); 
           String insQry="insert into tbl_driver_request(company_id,driver_id,request_date)values('"+cid+"','"+session.getAttribute("driverid")+"',curdate())";
        ...
        <form method="post">
            <table align="center" border="1">
                ...
                <tr>
                 ...
                 <tr>
                    <td colspan="3" align="center">
                        <a href="Viewcompany.jsp?cid=<%=rs.getString("company_id")%>">Request</a>
                    </td>
                </tr>
                <%
                        }
