<%-- 
    Document   : index
    Created on : May 28, 2021, 7:25:27 PM
    Author     : Pro-TECH
--%>
    ...
    <jsp:useBean class="DB.ConnectionClass" id="con"></jsp:useBean>
                ...
                <div class="navbar navbar-default navbar-fixed-top">
                    <div class="container">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand hidden-xs hidden-sm" href="#headerwrap"><h1> Go-Between</h1></a>
                        </div>
                        <div class="navbar-collapse collapse">
                            <ul class="nav navbar-nav">
                                <div class="dropdown">
                                    <a class="dropbtn" href="#headerwrap">Home</a>
                                </div>
                                <div class="dropdown">
                                ...
                                %>
                                <div class="dropdown">
                                    <a class="dropbtn" href="ViewLicence.jsp">License</a>
                                </div>
                                <%
                                    }
                                    else
                                    {
                                        %>
                                <div class="dropdown">
                                    <a class="dropbtn" href="License.jsp">License</a>
                                </div>
                                <%
                                    }
                            ...
                            <div class="dropdown">
                                <a class="dropbtn" href="javascript:void(0)">Trip</a>
                                <div class="dropdown-content">
                                    <a href="AssignedTrip.jsp">Assigned Trip </a>
                                </div>
                            </div>
                            <div class="dropdown">
                                <a class="dropbtn" href="javascript:void(0)">Job</a>
                                <div class="dropdown-content">
                                    <a href="SearchCompany.jsp">Search Company </a>
                                    <a href="MyRequest.jsp">My Request</a>
                                </div>
                            </div>
                            <div class="dropdown">
        ...
        <div id="headerwrap" >
            <header class="clearfix">
                <h1 class="animated bounceIn">Welcome <br><%=session.getAttribute("dname")%></h1>
            ...
            <div class="row white centered">
                ...
                <div class="col-md-4 ">
                    <div class="col-md-3 col-sm-3 col-xs-3 fade-down team-image-wrapper">
                        <img class="img team-image" src="../Assets/Templates/web/images/team01.jpg" alt="">
                ...
                <div class="col-md-4">
                    <div class="col-md-3 col-sm-3 col-xs-3 fade-down team-image-wrapper">
                        <img class="img team-image" src="../Assets/Templates/web/images/team02.jpg" alt="">
                        <a href="#" class="team-social twitter"><i class="el-icon-twitter"></i></a>
                        <a href="#" class="team-social facebook"><i class="el-icon-facebook"></i></a>
                        <a href="#" class="team-social flickr"><i class="el-icon-flickr"></i></a>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="col-md-3 col-sm-3 col-xs-3 fade-down team-image-wrapper">
                        <img class="img team-image" src="../Assets/Templates/web/images/team03.jpg" alt="">
                        <a href="#" class="team-social twitter"><i class="el-icon-twitter"></i></a>
                        <a href="#" class="team-social facebook"><i class="el-icon-facebook"></i></a>
                        <a href="#" class="team-social flickr"><i class="el-icon-flickr"></i></a>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 centered fade-up">
                        <img class="img-responsive" src="../Assets/Templates/web/images/macbook.png" align="">
                    </div>
                ...
                <div class="">	
                    ...
                    <div id="portfolio-carousel">
                        ...
                        <div class="fade-up col-md-4 ">
                            <div class="grid mask">
                                <figure>
                                    <img class="img-responsive" src="../Assets/Templates/web/images/folio01.jpg" alt="">
                                    <figcaption>
                                        <h5>PROJECT ONE</h5>
                        ...
                        <div class="fade-up col-md-4">
                            <div class="grid mask">
                                <figure>
                                    <img class="img-responsive" src="../Assets/Templates/web/images/folio02.jpg" alt="">
                                    <figcaption>
                                        <h5>PROJECT TWO</h5>
                                        <a href="single-project.html" class="btn btn-primary btn-lg"><i class="el-icon-link"></i></a>
                                        <a href="images/folio01.jpg" class="btn btn-primary btn-lg launch-lb"><i class="el-icon-zoom-in"></i></a>
                        ...
                        <div class="fade-up col-md-4">
                            <div class="grid mask">
                                <figure>
                                    <img class="img-responsive" src="../Assets/Templates/web/images/folio03.jpg" alt="">
                                    <figcaption>
                                        <h5>PROJECT THREE</h5>
                                        <a href="single-project.html" class="btn btn-primary btn-lg"><i class="el-icon-link"></i></a>
                                        <a href="images/folio01.jpg" class="btn btn-primary btn-lg launch-lb"><i class="el-icon-zoom-in"></i></a>
                        ...
                        <div class="fade-up col-md-4 ">
                            <div class="grid mask">
                                <figure>
                                    <img class="img-responsive" src="../Assets/Templates/web/images/folio04.jpg" alt="">
                                    <figcaption>
                                        <h5>PROJECT FOUR</h5>
                                        <a href="single-project.html" class="btn btn-primary btn-lg"><i class="el-icon-link"></i></a>
                                        <a href="images/folio01.jpg" class="btn btn-primary btn-lg launch-lb"><i class="el-icon-zoom-in"></i></a>
                        ...
                        <div class="fade-up col-md-4">
                            <div class="grid mask">
                                <figure>
                                    <img class="img-responsive" src="../Assets/Templates/web/images/folio05.jpg" alt="">
                                    <figcaption>
                                        <h5>PROJECT FIVE</h5>
                                        <a href="single-project.html" class="btn btn-primary btn-lg"><i class="el-icon-link"></i></a>
                                        <a href="images/folio01.jpg" class="btn btn-primary btn-lg launch-lb"><i class="el-icon-zoom-in"></i></a>
                        ...
                        <div class="fade-up col-md-4">
                            <div class="grid mask">
                                <figure>
                                    <img class="img-responsive" src="../Assets/Templates/web/images/folio06.jpg" alt="">
                                    <figcaption>
                                        <h5>PROJECT SIX</h5>
                                        <a href="single-project.html" class="btn btn-primary btn-lg"><i class="el-icon-link"></i></a>
                                        <a href="images/folio01.jpg" class="btn btn-primary btn-lg launch-lb"><i class="el-icon-zoom-in"></i></a>
            ...
            <div class="row">
                ...
                <div class="col-md-6 blog-bg">
                    <div class="img-wrapper">
                        <img class="img fade-down" src="../Assets/Templates/web/images/bg1.jpg">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-2 blog-meta fade-down">
                        <img class="img" src="../Assets/Templates/web/images/team01.jpg">
                        <h4>John Smith</h4>
                ...
                <div class="col-md-6 blog-bg">
                    <div class="img-wrapper">
                        <img class="img fade-down" src="../Assets/Templates/web/images/bg2.jpg">
                        <div class="img-mask"><a href="single-post.htm" class="mask-icon"><i class="el-icon-link"></i></a></div>
                    </div>
                    <div class="col-md-2 col-sm-2 col-xs-2 blog-meta fade-down">
                        <img class="img" src="../Assets/Templates/web/images/team02.jpg">
                        <h4>Dan Jones</h4>
                ...
                <div class="col-md-6 blog-bg">
                    <div class="img-wrapper">
                        <img class="img fade-down" src="../Assets/Templates/web/images/bg3.jpg">
                        <div class="img-mask"><a href="single-post.htm" class="mask-icon"><i class="el-icon-link"></i></a></div>
                    </div>
                    <div class="col-md-2 col-sm-2 col-xs-2 blog-meta fade-down">
                        <img class="img" src="../Assets/Templates/web/images/team03.jpg">
                        <h4>John Smith</h4>
                ...
                <div class="col-md-6 blog-bg">
                    <div class="img-wrapper">
                        <img class="img fade-down" src="../Assets/Templates/web/images/bg4.jpg">
                        <div class="img-mask"><a href="single-post.htm" class="mask-icon"><i class="el-icon-link"></i></a></div>
                    </div>
                    <div class="col-md-2 col-sm-2 col-xs-2 blog-meta fade-down">
                        <img class="img" src="../Assets/Templates/web/images/team03.jpg">
        ...
        <div id="footerwrap">
            <div class="container">
                ...
                <h4 class="fade-up">Created by <a href="http://templatestock.co">Go-Between</a> - Copyright 2021</h4>
            </div>
        </div>
        ...
        <script type="text/javascript" src="../Assets/Templates/web/js/bootstrap.js"></script>
        <script type="text/javascript" src="../Assets/Templates/web/js/plugins.js"></script>
        <script type="text/javascript" src="../Assets/Templates/web/js/init.js"></script>
    </body>
</html>
