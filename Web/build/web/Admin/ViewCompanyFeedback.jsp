<%-- 
    Document   : ViewCompanyFeedback
    Created on : May 23, 2021, 5:40:36 PM
    Author     : Pro-TECH
--%>
                            ...
                            <div class="QA_section">
                                <div class="QA_table mb_30">
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            <%                                                int i = 0;
                                                String selQry = "select * from tbl_feedback c inner join tbl_company co on co.company_id=c.company_id ";
