<%-- 
    ...
    Created on : May 16, 2021, 3:16:31 PM
    Author     : Pro-TECH
--%>
<%-- 
    Document   : NewUserList
...
<html lang="en" >
    <head>
        ...
        {
            String upQry = "update tbl_user set user_status='1' where user_id='"+request.getParameter("adid")+"'";
            con.executeCommand(upQry);
            response.sendRedirect("NewUserList.jsp");
        }
        
        if(request.getParameter("rdid")!=null)
        {
            String upQry = "update tbl_user set user_status='2' where user_id='"+request.getParameter("rdid")+"'";
            con.executeCommand(upQry);
            response.sendRedirect("NewUserList.jsp");
        }
    ...
    <body>
        <h1 align="center" id="heading">New User List</h1>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                   int i = 0;
                    String selQry = "select * from tbl_user c inner join tbl_location l on l.location_id=c.location_id inner join tbl_district d on d.district_id=l.district_id inner join tbl_state s on s.state_id=d.state_id where user_status='0'";
                ...
                <tr>
                    ...
                    <td><a href="NewUserList.jsp?adid=<%=rs.getString("user_id")%>">Accept</a> | 
                        <a href="NewUserList.jsp?rdid=<%=rs.getString("user_id")%>">Reject</a></td>
                </tr>
                <%
                    }
