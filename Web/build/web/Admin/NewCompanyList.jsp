<%-- 
    Document   : NewCompanyList
    Created on : May 16, 2021, 3:05:57 PM
    Author     : Pro-TECH
--%>
...
<html lang="en" >
    <head>
        ...
        {
            String upQry = "update tbl_company set company_status='1' where company_id='"+request.getParameter("acid")+"'";
    ...
    <body>
        <h1 align="center" id="heading">New Company List</h1>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                   int i = 0;
                    String selQry = "select * from tbl_company c inner join tbl_location l on l.location_id=c.location_id inner join tbl_district d on d.district_id=l.district_id inner join tbl_state s on s.state_id=d.state_id where company_status='0'";
                ...
                <tr>
                    ...
                    <td><a href="NewCompanyList.jsp?acid=<%=rs.getString("company_id")%>">Accept</a> | 
                    <a href="NewCompanyList.jsp?rcid=<%=rs.getString("company_id")%>">Reject</a></td>
                </tr>
                <%
                    }
