...
<html lang="en" >
    <head>
        ...
        {
            String upQry = "update tbl_driver set driver_status='1' where driver_id='"+request.getParameter("adid")+"'";
            con.executeCommand(upQry);
            response.sendRedirect("NewDriverList.jsp");
        }
        
        if(request.getParameter("rdid")!=null)
        {
            String upQry = "update tbl_driver set driver_status='2' where driver_id='"+request.getParameter("rdid")+"'";
            con.executeCommand(upQry);
            response.sendRedirect("NewDriverList.jsp");
        }
    ...
    <body>
        <h1 align="center" id="heading">New Driver List</h1>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                   int i = 0;
                    String selQry = "select * from tbl_driver c inner join tbl_location l on l.location_id=c.location_id inner join tbl_district d on d.district_id=l.district_id inner join tbl_state s on s.state_id=d.state_id where driver_status='0'";
                ...
                <tr>
                    ...
                    <td><a href="NewDriverList.jsp?adid=<%=rs.getString("driver_id")%>">Accept</a> | 
                        <a href="NewDriverList.jsp?rdid=<%=rs.getString("driver_id")%>">Reject</a></td>
                </tr>
                <%
                    }
