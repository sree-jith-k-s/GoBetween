<%-- 
    Document   : ViewDriverComplaint
    Created on : May 16, 2021, 3:07:59 PM
    Author     : Pro-TECH
--%>
...
<html>
    ...
    <%        if (request.getParameter("btn_save") != null) {
            ...
            response.sendRedirect("ViewDriverComplaint.jsp");
        }
                            ...
                            <div class="QA_section">
                                ...
                                <div class="QA_table mb_30">
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            <%                                                int i = 0;
                                                String selQry = "select * from tbl_complaint c inner join tbl_complainttype ct on ct.complainttype_id=c.complainttype_id inner join tbl_driver co on co.driver_id=c.driver_id where complaint_status='0'";
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><a href="ViewDriverComplaint.jsp?up=<%=rs.getString("complaint_id")%>" class="status_btn">Reply</a> </td>
                                            </tr>
                                            <%                      }
                                ...
                                <div class="QA_table mb_30">
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            <%                                                int j = 0;
                                                String selQry1 = "select * from tbl_complaint c inner join tbl_complainttype ct on ct.complainttype_id=c.complainttype_id inner join tbl_driver co on co.driver_id=c.driver_id where complaint_status='1'";
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><%=rs1.getString("driver_name")%></td>
