<%-- 
    Document   : RejectedCompanyList
    Created on : May 16, 2021, 3:06:14 PM
    Author     : Pro-TECH
--%>
...
<html lang="en" >
    ...
    <body>
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                   int i = 0;
                    String selQry = "select * from tbl_company c inner join tbl_location l on l.location_id=c.location_id inner join tbl_district d on d.district_id=l.district_id inner join tbl_state s on s.state_id=d.state_id where company_status='2'";
                ...
                <tr>
                    ...
                    <td><a href="NewCompanyList.jsp?acid=<%=rs.getString("company_id")%>">Accept</a></td>
                </tr>
                <%
                    }
