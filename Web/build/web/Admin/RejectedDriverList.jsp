<%-- 
    Document   : RejectedDriverList
    Created on : May 16, 2021, 3:16:07 PM
    Author     : Pro-TECH
--%>
...
<html lang="en" >
    <head>
        ...
        if(request.getParameter("adid")!=null)
        {
            ...
            response.sendRedirect("RejectedDriverList.jsp");
        }
    ...
    <body>
        <h1 align="center" id="heading">Rejected Driver List</h1>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                   int i = 0;
                    String selQry = "select * from tbl_driver c inner join tbl_location l on l.location_id=c.location_id inner join tbl_district d on d.district_id=l.district_id inner join tbl_state s on s.state_id=d.state_id where driver_status='2'";
                ...
                <tr>
                    ...
                    <td><a href="RejectedDriverList.jsp?adid=<%=rs.getString("driver_id")%>">Accept</a></td>
                </tr>
                <%
                    }
