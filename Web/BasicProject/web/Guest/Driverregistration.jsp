...
<html>
    ...
    <body>
        <h1 align="center">Driver Registration</h1>

        <form method="post" enctype="multipart/form-data" action="../Assets/ActionPages/DriverActionPage.jsp">
            <table border="1" align="center">
                ...
                <tr>
                    ...
                    <td><input type="text" name="txtpcontact"></td>
                </tr>
                <tr>
                    <td>Secondary Contact</td>
                    <td><input type="text" name="txtscontact"></td>
                </tr>
                <tr>
                    <td>DOB</td>
                ...
                <tr>
                    <td>Experience</td>
                    <td><input type="text" name="txtexp"></td>
                </tr>
                 <tr>
                    <td>State</td>
